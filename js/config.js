...
export const CONFIG = {
  ...
  VERIFY_MIN_CORRECTION_LENGTH_RATIO: 0.8,
  OCR_RULING_ROW_FRACTION: 0.45,
  OCR_RULING_COLUMN_FRACTION: 0.18,
  OCR_RULING_CLUSTER_POINTS: 2,
  OCR_CROP_PADDING_POINTS: 1,
  OCR_MIN_COLUMN_POINTS: 8,
  OCR_NARROW_COLUMN_POINTS: 50,
  OCR_CELL_MARGIN_POINTS: 4,
  VERIFY_OVERLAP: 0.3,
